...
class InGameEscMenuOverlay(Scene):
    ...
    def load_content(self):
        ...
        action_continue = FadeButton(self, utils.load_ui_image("igesc-action-continue"), (762, 125))
        ...
        def to_main_menu(sender, button):
            ...
            self.toggle_visibility()
        action_exit = FadeButton(self, utils.load_ui_image("igesc-action-exit"), (924, 499))
